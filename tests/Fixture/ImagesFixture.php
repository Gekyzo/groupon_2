...
class ImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'path' => ['type' => 'string', 'length' => 512, 'null' => false, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'name' => ['type' => 'unique', 'columns' => ['name', 'path'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-02-27 12:24:59',
                'deleted' => '2020-02-27 12:24:59',
            ],
        ];
        parent::init();
    }
